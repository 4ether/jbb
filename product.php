  ...
  <div class="container">
    <div class="row row-product bg-light">
      ...
      <div class="col-md-7 col-12">
        ...
        <h3 class="h3-header">Rp <?php echo number_format($harga, 0, ',', '.');?></h3>
              ...
              <form action="productFunction.php?id=<?php echo $id?>" method="POST">
                <div class="row">
                  <div class="col">
                    ...
                    <div class="inputDiv">
                        <h5>Rp</h5>
                        <input required name="nominal" class="form-control ms-2 mb-4 w-100" type="text" placeholder="Nominal"
                       autocomplete="off">
                    </div>
                </div>
              </div>
