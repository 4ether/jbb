            ...
            <div class="container">
                <div class="row g-0">
                    ...
                    <div class="col-lg-6 px-5 pt-5">
                        ...
                        <p>Halo! selamat datang di Midnightcoder Store, silahkan masukan identitas anda.</p>
                        <form action="registerFunction.php" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col-lg-9">
                                    <input onfocus="remNotif();" type="number" name="notelp" id="notelp" placeholder="No Telp" class="inf form-control my-3 p-3" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-lg-9">
