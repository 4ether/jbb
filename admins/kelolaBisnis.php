    ...
    <body class="hold-transition sidebar-mini">
                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="kelolaBisnis.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Pengelola Bisnis Pengusaha</h1>
                </div>
                </div>
            </div><!-- /.container-fluid -->
            </section>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php
                    ...
                    $sql = mysqli_query($conn, "SELECT *, b.nama AS namaBisnis, pg.nama AS namaPemilik FROM bisnis b JOIN pengguna pg ON b.idPengusaha = pg.id");
                    ...
                    if($count > 0) {
                      while ($fetchData =  mysqli_fetch_array($sql)) {
                        $no++;
                        $idPn = $fetchData['id'];
                        $namaBisnis = $fetchData['namaBisnis'];
                        $namaPemilik = $fetchData['namaPemilik'];
                        $deskripsi = $fetchData['deskripsi'];
                        $hargaAsliPn = number_format($fetchData['harga'], 0, ',', '.');
                        $tahun = $fetchData['didirikan'];
                        $status = $fetchData['status'];
                        $jenis = $fetchData['jenis'];
                        $fitur = $fetchData['fitur'];
                        $benda = $fetchData['benda'];
                        $alamat = $fetchData['alamat'];
                        $rataB = $fetchData['rataPerB'];
                        $rataT = $fetchData['rataPerT'];
                        $mapLat = $fetchData['mapLat'];
                        $mapLng = $fetchData['mapLng'];

                        // mengecek $mapLat dan $mapLng tidak null
                        if (!empty($mapLat) && !empty($mapLng)) {
                            $mapIframe = "<iframe src='https://maps.google.com/maps?q=$mapLat,$mapLng&t=&z=15&ie=UTF8&iwloc=&output=embed' frameborder='0'></iframe>";
                        } else {
                            $mapIframe = "<span class='centered-text'>Lokasi Map tidak di set pengguna</span>";
                        }
                        ...
                        <tr>
                          ...
                          <td>$namaBisnis</td>
                          <td>$namaPemilik</td>
                          <td>" . truncateDescription($deskripsi) . "</td>
